...
function HeaderComp() {
  return (
    <div className=" p-3 border-green border-2 flex justify-between items-center ">
      ...
      <div className="flex gap-3">
        <Link className=" hover:text-cyan-500 p-1 border-2 border-green  flex flex-col justify-center items-center">
